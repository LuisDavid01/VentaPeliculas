...
Router.get('/Promociones' ,verifyToken, validateRol('Admin'),promocionesController.getPromociones);
Router.get('/Promociones/:id',verifyToken, validateRol('Admin'),promocionesController.getPromocion);
